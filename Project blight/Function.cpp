...
Utils::Fn<int, uintptr_t*, uintptr_t*, BYTE>					getItemHanded;
...
getItemHanded	= Utils::CreateFastCall<int, uintptr_t*, uintptr_t*, BYTE>(Utils::GetAddressfromSignature(getitemhanded));
